...
import ch.ehi.ili2db.base.Ili2dbInit;
import ch.ehi.ili2db.base.Ili2dbInitNull;
import ch.ehi.ili2db.base.NameOptimizer;
 ...
 */
public class Ili2dbTransactional {
	...
	public static void runImport(Config config,String appHome,java.sql.Connection conn) 
	throws Ili2dbException
		{
...
//					}
	...
	public static void runSchemaImport(Config config,String appHome,java.sql.Connection conn) 
	throws Ili2dbException
	{
		ch.ehi.basics.logging.FileListener logfile=null;
		if(config.getLogfile()!=null){
